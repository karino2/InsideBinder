...
== 8.2.1 Binderとシステムサービスを詳細に理解する意義

8.1の内容で、他の章を読んだりソースコードを読んでいく分には十分と言いました。
...
まず8.3、8.4、8.5の三つの節でbinderドライバのレイヤの話をします。
その後8.6でスレッドプールのレイヤを、8.7で共通ネイティブインターフェースのレイヤを扱い、
8.8でAIDLのレイヤ、つまりJavaによるシステムサービス実装を扱います。

最後に8.9でBinderの仕組みを実際に使っている側に視点を移して、
