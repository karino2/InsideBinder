...
一方で本章は本編の他の章よりも読者に要求する前提知識が多く、本編の中では少し特殊な章となっています。
そこで最初に@<hd>{sec81}で、まあり前提知識が無い読者を想定して、本編の他の章を理解するのに必要な最低限の事、ひいてはAndroidという物を理解するのに必要なBinderの最低限の所を説明する事から始める事にしました。

あまりこの分野に馴染みのない人がどこまで本章を読むのかは、@<hd>{sec81}を読んで、自身で判断してもらいたい、と思っています。
@<hd>{sec81}の内容さえ理解しておけば、他の章を読むのには差し支えありません。
本章が難しいと思ったら@<hd>{sec81}だけ読んだ上で次の章に進んでもらえたら、と思います。
